...
CREATE TABLE `employees` (
  ...
  `COMMISSION_PCT` decimal(6,2) DEFAULT NULL,
  `MANAGER_ID` int(11) DEFAULT NULL,
...
INSERT INTO `job_history` VALUES (102,'2001-01-13','2006-07-24','IT_PROG',60,1),(101,'1997-09-21','2001-10-27','AC_ACCOUNT',110,2),(101,'2001-10-28','2005-03-15','AC_MGR',110,3),(201,'2004-02-17','2007-12-19','MK_REP',20,4),(114,'2006-03-24','2007-12-31','ST_CLERK',50,5),(122,'2007-01-01','2007-12-31','ST_CLERK',50,6),(200,'1995-09-17','2001-06-17','AD_ASST',90,7),(176,'2006-03-24','2006-12-31','SA_REP',80,8),(176,'2007-01-01','2007-12-31','SA_MAN',80,9),(200,'2002-07-01','2006-12-31','AC_ACCOUNT',90,10);
...
INSERT INTO `jobs` VALUES ('AC_ACCOUNT','Public Accountant',4200.00,9000.00),('AC_MGR','Accounting Manager',8200.00,16000.00),('AD_ASST','Administration Assistant',3000.00,6000.00),('AD_PRES','President',20080.00,40000.00),('AD_VP','Administration Vice President',15000.00,30000.00),('FI_ACCOUNT','Accountant',4200.00,9000.00),('FI_MGR','Finance Manager',8200.00,16000.00),('HR_REP','Human Resources Representative',4000.00,9000.00),('IT_PROG','Programmer',4000.00,10000.00),('MK_MAN','Marketing Manager',9000.00,15000.00),('MK_REP','Marketing Representative',4000.00,9000.00),('PR_REP','Public Relations Representative',4500.00,10500.00),('PU_CLERK','Purchasing Clerk',2500.00,5500.00),('PU_MAN','Purchasing Manager',8000.00,15000.00),('SA_MAN','Sales Manager',10000.00,20080.00),('SA_REP','Sales Representative',6000.00,12008.00),('SH_CLERK','Shipping Clerk',2500.00,5500.00),('ST_CLERK','Stock Clerk',2008.00,5000.00),('ST_MAN','Stock Manager',5500.00,8500.00);
...
-- Dump completed on 2014-11-21 20:23:48
